...
using ScendMvc.Infrastructure.Helper;
using ScendMvc.Infrastructure.Mapper;
using ScendMvc.Models;
using ScendMvc.Models.Paypal;
using ScendMvc.Models.Paypal.Enum;
using ScendMvc.Models.Paypal.text;
using ScendMvc.Models.Paypal.text.DTO;
using static ScendMvc.Models.Paypal.PaypalAgreementRequest;
using Payer = ScendMvc.Models.Paypal.PaypalAgreementRequest.Payer;
...
namespace ScendMvc.Controllers
{
    public class PaypalController : Controller
    {
        ...
        public async Task<object> paypaltopup()
        {
            ...
            var cus = _myDbContext.PaypalTokenId.Where(s => s.Email == "sb-noace2974666@personal.example.com").FirstOrDefault();
        ...
        public async Task<LinkAgreement> paypalapproval()
        {
            ...
            {
                var token = await GetPaypalAccessToken();
                var cus = _myDbContext.PaypalTokenId.Where(s => s.Email == "sb-pmqgc2974574@personal.example.com").FirstOrDefault();
